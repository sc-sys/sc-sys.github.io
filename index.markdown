...
---
  ...
  <main class="page-content" aria-label="Content">
    ...
    <p>
      <A href="https://ds.rois.ac.jp/center9/">情報・システム研究機構 データサイエンス共同利用基盤施設 セキュアコンピュータシステム研究開発センター(CRADSEC)</A>
    </p>

    <h3><p style="line-height:0.3">世話人</p></h3>
    <ul style="line-height:1.1">
      <li>関山 太朗（国立情報学研究所／情報・システム研究機構CRADSEC）</li>
      <li>大畑 幸矢 (情報・システム研究機構CRADSEC)</li>
      <li>畑 輝史（慶應義塾大学）</li>
    </ul>
    ...
    <UL class="workshop-list" style="line-height:1.1">
     <li>
       ...
       <ul class="program">
         ...
         <li>
           <dt style="line-height:1.5">16:00-17:00 Izumi Tanaka (University of Tokyo)</dt>
    ...
    <UL class="workshop-list" style="line-height:1.1">
     <li>
       ...
       <dt>開催場所：一橋講堂特別会議室101ー103</dt>
       <dt>参加登録：<a href="https://forms.gle/EARUhPjHn3FRh1u36">Google form</a> より受付（懇親会登録締切：11月14日）</dt>

       <dt>プログラム</dt>
       <ul class="program">
         <li>
           <dt style="line-height:1.5">13:30-14:30 大堀 淳（情報・システム研究機構CRADSEC）</dt>
           <dt style="line-height:1.5">講演タイトル：プログラミングの観点から理解するTrusted Execution Environment（TEE）の本質とその技術課題</dt>
           <details>
             <SUMMARY>概要</SUMMARY>
             <DIV class="abstract">
               Trusted Execution Environment（TEE）は、機微情報等を扱うアプリケーションの安全な実行を保証する枠組みである。通常のTEEに関する解説では、Intel SGXやAMD SEV-SNPなどのハードウェアが提供するTEE機能と、それら機能によって実現される隔離領域でのプログラム実行の性質と制御機構が説明される。しかしそれら詳細な技術的な解説のみからTEEの本質を理解するのは難しいとの印象を持つ。そこで本講演では、TEEに興味を持つ大学院生・技術者等を対象に、プログラミングの観点から、TEEが「何を信頼し、何を何から守るか」に関する解説を試みる。保護対象コードを攻撃コードからどう識別するか等を理解した後、隔離領域の仮想化や保護対象コードの認証等における技術課題を議論する。
             </DIV>
           </details>
         </li>
         <li>
           <dt style="line-height:1.5">14:30-15:30 佐藤 重幸（電気通信大学）</dt>
           <dt style="line-height:1.5">講演タイトル：探索的コンパイラ最適化の再興と展望 </dt>
           <details>
             <SUMMARY>概要</SUMMARY>
             <DIV class="abstract">
               コンパイラの文脈における探索に基づくコード最適化のアプローチsuperoptimizationは，特定アーキテクチャ向けの低水準最適化器の構成法としてMassalinによって1987年に提案された．
               その基本的な考えは，与えられたアセンブリ列から仕様を構成し，その仕様を満たす最短の命令列を，検証器を使いながら探索的に構成するものである．
               時代が進み，SMTソルバに代表される形式検証器の発達に伴い，2010年代にはドメイン特化言語（DSL）上でSMTソルバを使いながら探索的にプログラムを構成するプログラム合成技術が発達した．
               そして，2010年代後半における深層学習向けDSLと深層学習向けのドメイン特化アーキテクチャの勃興により，深層学習向けのsuperoptimizationが研究されるようになり，現在に至っている．
               本講演では，マイルストーンとなる仕事を紹介しながらsuperoptimizationを概観し，今後の展望を論じる． 
             </DIV>
           </details>
         </li>
         <li>
           <dt>15:30-15:50 休憩</dt>
         </li>
         <li>
           <dt style="line-height:1.5">15:50-16:50 パネル討論：ハードウェア，ソフトウェア，形式検証の垣根を越えて</dt>
           <dt style="line-height:1.5">討論者：五島 正裕（国立情報学研究所／情報・システム研究機構CRADSEC），河野　健二（慶應義塾大学／情報・システム研究機構CRADSEC），小林 直樹（東京大学／情報・システム研究機構CRADSEC）</dt>
         </li>
         <li>
